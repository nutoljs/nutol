...
module.exports = {
  ...
  rules: {
    ...
    /**
     * Rules imported from eslint-config-nutol
     */
    ...
    // Rules mapped from `@nutol/tslint-config/tslint.common.json
    ...
    // Rules mapped from `@nutol/tslint-config/tslint.build.json
